        ...
        <div class="row question-filter">
            <div class="col-md-12 sort-questions">
                <ul>
                    ...
                    <li>
                        <a class="<?php if(isset($_GET['type']) && $_GET['type'] == "answer") echo 'active'; ?>" href="<?php echo esc_url( add_query_arg(array('type'=>'answer'))); ?>"><?php _e('Answers',ET_DOMAIN) ?></a>
                    </li>
                    <?php if($current_user->ID == $user->ID){ ?>
                    <li>
                        <a class="<?php if(isset($_GET['type']) && $_GET['type'] == "following") echo 'active'; ?>" href="<?php echo esc_url( add_query_arg(array('type'=>'following'))); ?>"><?php _e('Following',ET_DOMAIN) ?></a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
